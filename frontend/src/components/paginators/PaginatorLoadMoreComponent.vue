...
const progress = computed(() =>
  Math.round(utilsH.percentOf(props.params.page, props.params.lastPage)),
)
...
<template>
  <div class="f-center f-column">
    ...
    >
      {{ t('paginator.loadmore_info', { currentPage: params.page, totalPage: params.lastPage }) }}
    </p>
    <div class="progressbar | bg-neutral-300 my-10">
      <div
        class="progressbar-content | h-100 bg-primary"
