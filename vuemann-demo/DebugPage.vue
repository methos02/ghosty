<template>
  ...
  <p>Cette page explique les différentes procédures pour débugger une application avec Vuemann.</p>
  ...
  <p>
    ...
    localisation des erreurs facilement. Une solution pour afficher la localisation exacte des
    erreurs serait de désactiver la minification des fichiers. Cependant, cette solution comporte
    deux inconvénients majeurs : le chargement de l'application sera plus long et révéler le code
    source de l'application en clair sur le client pose un risque de sécurité.
  </p>
  <p>Pour cela, vous devez suivre les deux étapes suivantes :</p>
  <ol class="ml-25">
    <li class="mb-5">
      <p>
        Placer votre erreur dans le fichier <span class="badge-code">error.log</span> à la racine de
        l'application
      </p>
    </li>
    <li>
      <p>Lancer la commande <span class="badge-code">npx sourcemap</span></p>
    </li>
  </ol>

  <h2 class="h2">Utilitaires de test disponibles</h2>
  <p>
    Vuemann fournit plusieurs utilitaires et mocks pour faciliter l'écriture de tests unitaires et
    d'intégration.
  </p>
  ...
  <ul class="list ml-25">
    ...
    <li>
      <a
        href="#trigger-input"
        class="link-underline"
        >triggerInput(wrapper, selector, value)</a
      >
    </li>
    <li>
      <a
        href="#trigger-confirm"
        class="link-underline"
        >triggerConfirm(wrapper, type)</a
      >
    </li>
    <li>
      <a
  ...
  <ul class="list ml-25">
    <li>
      <a
        href="#extract-translation-file"
        class="link-underline"
        >extractTranslationKeysFromFile(filePath)</a
      >
    </li>
    <li>
      <a
        href="#extract-translation-component"
        class="link-underline"
        >extractTranslationKeysFromComponent(componentPath)</a
      >
    </li>
    <li>
      <a
        href="#compare-translation-keys"
        class="link-underline"
        >compareTranslationKeys(jsonKeys, componentKeys)</a
      >
    </li>
  </ul>
  ...
  <ul class="list ml-25">
    ...
    <li>
      <a
        href="#router-service-mock"
        class="link-underline"
        >router-service-mock.js</a
      >
    </li>
    <li>
      <a
  ...
  <ul class="list ml-25">
    <li>
      <a
        href="#configuration-vitest"
        class="link-underline"
        >Configuration Vitest</a
      >
    </li>
    <li>
      <a
        href="#exemple-complet"
        class="link-underline"
        >Exemple de test complet</a
      >
    </li>
  </ul>
  ...
  <p>
    ...
    <span class="badge-code">tests/utils/functions/utils.js</span> :
  </p>
  ...
  <p>
    Initialise un routeur Vue Router pour les tests avec la configuration des routes de
    l'application.
  </p>
  <div class="div-code">
  ...
  <h4
    ...
    id="trigger-input"
  >
    triggerInput(wrapper, selector, value)
  </h4>
  <p>
    Simule la saisie dans un champ de formulaire et déclenche l'événement input avec un délai.
    <strong>Important :</strong> Cette fonction utilise des timers, vous devez activer les
    fakeTimers dans vos tests.
  </p>
  <div class="div-code">
  ...
  <h4
    ...
    id="trigger-confirm"
  >
    triggerConfirm(wrapper, type)
  </h4>
  <p>
    Simule le processus de confirmation pour les composants ConfirmButtonComponent ou
  ...
  <h4
    ...
    id="trigger-loader"
  >
    triggerLoader(wrapper)
  </h4>
  <p>Simule le clic sur le bouton d'un LoaderComponent.</p>
  <div class="div-code">
  ...
  <h3
    class="h3"
    id="fonctions-traduction"
  >
    Fonctions de test de traduction
  </h3>
  <p>
    Ces fonctions sont disponibles dans
    <span class="badge-code">tests/utils/functions/translate-test-functions.js</span> :
  </p>

  <h4
    class="h4"
    id="extract-translation-file"
  >
    extractTranslationKeysFromFile(filePath)
  </h4>
  <p>Extrait toutes les clés de traduction d'un fichier JSON de traduction.</p>
  <div class="div-code">
    <span class="color-green">// Extraction des clés de traduction</span><br />
    import { extractTranslationKeysFromFile } from
    '@/tests/utils/functions/translate-test-functions.js'<br />
    <br />
  ...
  <h4
    class="h4"
    id="extract-translation-component"
  >
    extractTranslationKeysFromComponent(componentPath)
  </h4>
  <p>Extrait toutes les clés de traduction utilisées dans un composant Vue.</p>
  <div class="div-code">
    <span class="color-green">// Extraction des clés d'un composant</span><br />
    import { extractTranslationKeysFromComponent } from
    '@/tests/utils/functions/translate-test-functions.js'<br />
    <br />
  ...
  <h4
    class="h4"
    id="compare-translation-keys"
  >
    compareTranslationKeys(jsonKeys, componentKeys)
  </h4>
  <p>
    Compare les clés de traduction entre un fichier JSON et un composant pour détecter les clés
    manquantes ou inutilisées.
  </p>
  <div class="div-code">
  ...
  <h3
    class="h3"
    id="mocks-disponibles"
  >
    Mocks disponibles
  </h3>
  <p>Les mocks sont disponibles dans <span class="badge-code">tests/utils/mocks/</span> :</p>
  ...
  <p>Mock pour les éléments HTMLDialogElement avec les méthodes showModal() et close().</p>
  <div class="div-code">
  ...
  <h4
    class="h4"
    id="router-service-mock"
  >
    router-service-mock.js
  </h4>
  <p>Mock pour le service de routage avec toutes les méthodes mockées.</p>
  <div class="div-code">
    ...
    <span class="color-green"
      >// Utilise routerServiceMock.hasApiRoute, routerServiceMock.push, etc.</span
    >
  </div>
  ...
  <p>Mock pour WebSocket avec simulation des événements open, close et error.</p>
  <div class="div-code">
  ...
  <p>Mock pour les fonctions du système de fichiers Node.js.</p>
  <div class="div-code">
  ...
  <p>Mock pour les fonctions de manipulation de chemins Node.js.</p>
  <div class="div-code">
  ...
  <p>Les seeders sont disponibles dans <span class="badge-code">tests/utils/seeders/</span> :</p>
  ...
  <p>Génère des données d'utilisateurs pour les tests.</p>
  <div class="div-code">
  ...
  <p>Génère des données de groupes pour les tests.</p>
  <div class="div-code">
  ...
  <p>Fournit les niveaux d'accès prédéfinis.</p>
  <div class="div-code">
  ...
  <h3
    class="h3"
    id="configuration-vitest"
  >
    Configuration Vitest
  </h3>
  <p>
    La configuration de test est définie dans <span class="badge-code">vitest.config.js</span> et
  ...
  <div class="div-code">
    ...
    <br />
    &emsp;beforeEach(() => {<br />
    &emsp;&emsp;vi.useFakeTimers() <span class="color-green">// Obligatoire pour triggerInput</span
    ><br />
    ...
    <br />
    &emsp;afterEach(() => {<br />
    &emsp;&emsp;vi.useRealTimers() <span class="color-green">// Restaurer les timers réels</span
    ><br />
    &emsp;})<br />
    <br />
