...
<template>
  ...
  <p>
    ...
    Lorsque la prop <code>label</code> est fournie, le composant affiche un
    <strong>label flottant</strong> sur le même principe que l'Input : le label se place dans le
    champ et remonte au focus/saisie.
  </p>
