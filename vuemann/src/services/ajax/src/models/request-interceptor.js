...
export const requestInterceptor = (config = {}) => {
  const bearer_token =
    Request.get('token', config.requestId) ??
    servicesM.service('auth:getAccessToken', Request.get('api', config.requestId))
  if (bearer_token !== null) {
    headersDefault['Authorization'] = 'Bearer ' + bearer_token
  }
