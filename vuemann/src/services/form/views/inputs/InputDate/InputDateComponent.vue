...
import CalendarPopup from '@brugmann/vuemann/src/services/form/views/inputs/InputDate/CalendarPopupComponent.vue'
...
import { InputDate } from '@brugmann/vuemann/src/services/form/views/inputs/InputDate/src/input-date.js'
import '@brugmann/vuemann/src/services/form/views/inputs/InputDate/src/input-date.scss'
