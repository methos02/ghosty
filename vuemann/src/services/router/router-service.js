import { getRouter } from '@brugmann/vuemann/src/services/router/src/router-plugin.js'
...
/** @type {import('@brugmann/vuemann/src/contracts/router-contract.js').RouterService} */
